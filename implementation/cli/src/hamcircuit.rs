...
use genome_graph::bigraph::traitgraph::io::write_hamcircuit_as_concorde_tsp;
...
pub struct HamCircuitCommand {
    ...
    #[clap(
        short,
        long,
        about = "The file to write the raw graph in TSPLIB format."
    )]
    output_raw: String,
...
pub(crate) fn hamcircuit(
    ...
    if let Some(random) = &subcommand.random {
        ...
        todo!("As of now, --random is required.")
    }
