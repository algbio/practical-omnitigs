...
REPORT_MANUAL_REDUCED_TEX = os.path.join(REPORT_MANUAL_DIR, "reduced.tex")
REPORT_MANUAL_REDUCED_PDF = os.path.join(REPORT_MANUAL_DIR, "reduced.pdf")
...
rule install_quast:
    ...
    shell: """
        ...
        cd quast
        git checkout 39cf5f04bd0d127480344d5d1c41226245f08b9b
    """
