...
rule install_wtdbg2:
    ...
    cd wtdbg2
    git checkout 654f5af8107f0fc6fb5d9b5c588c759324abcb95
    make
    """
...
rule install_flye:
    ...
    shell:  """
        ...
        cd Flye
        git checkout 81b3a4d83e61db21e55c5a44d8761966814ca822
...
rule ratatosk:
    ...
    resources: mem_mb = lambda wildcards: compute_genome_mem_mb_from_wildcards(wildcards, 80000),
               cpus = MAX_THREADS,
               time_min = lambda wildcards: compute_genome_time_min_from_wildcards(wildcards, 360),
               queue = lambda wildcards: compute_genome_queue_from_wildcards(wildcards, 360, 80000),
               mail_type = "END",
    shell: """
...
rule install_quast:
    ...
    cd quast
    git checkout 9f5c5b2ef9edba0ffc31d68e5a4a1fdbab925fe3
    """
